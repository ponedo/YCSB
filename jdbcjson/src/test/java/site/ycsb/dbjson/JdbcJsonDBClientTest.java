...
// public class JdbcJsonDBClientTest {
...
//     private static JdbcJsonDBClient jdbcJsonDBClient = null;
...
//         jdbcJsonDBClient = new JdbcJsonDBClient();

//         Properties p = new Properties();
//         p.setProperty(JdbcJsonDBClient.CONNECTION_URL, TEST_DB_URL);
//         p.setProperty(JdbcJsonDBClient.DRIVER_CLASS, TEST_DB_DRIVER);
//         p.setProperty(JdbcJsonDBClient.CONNECTION_USER, TEST_DB_USER);
//         p.setProperty(JdbcJsonDBClient.DB_BATCH_SIZE, Integer.toString(batchSize));
//         p.setProperty(JdbcJsonDBClient.JDBC_BATCH_UPDATES, "true");
//         p.setProperty(JdbcJsonDBClient.JDBC_AUTO_COMMIT, Boolean.toString(autoCommit));

//         jdbcJsonDBClient.setProperties(p);
//         jdbcJsonDBClient.init();
//       } catch (SQLException e) {
//         e.printStackTrace();
//         fail("Could not create local Database");
//       } catch (DBException e) {
//         e.printStackTrace();
//         fail("Could not create JdbcJsonDBClient instance");
//       }
//     }
...
//         try {
//             if (jdbcJsonDBClient != null) {
//                 jdbcJsonDBClient.cleanup();
//             }
//         } catch (DBException e) {
//             e.printStackTrace();
//         }
...
//     /*
//         Inserts a row of deterministic values for the given insertKey using the jdbcJsonDBClient.
//      */
...
//         }
//         jdbcJsonDBClient.insert(TABLE_NAME, insertKey, insertMap);
...
//             jdbcJsonDBClient.update(TABLE_NAME, "user1", updateMap);
...
//         jdbcJsonDBClient.read(TABLE_NAME, insertKey, readFields, readResultMap);
...
//             jdbcJsonDBClient.delete(TABLE_NAME, deleteKey);
...
//         jdbcJsonDBClient.scan(TABLE_NAME, KEY_PREFIX + startIndex, resultRows, fieldSet, resultVector);
